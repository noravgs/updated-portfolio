...
const IntroPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>Nora Vargas - Portfolio</title>
        <meta name="description" content="Hola! My name is Nora Vargas, a Software Engineer with a strong design sense. I'm passionate about crafting AI applications and fullstack solutions that solve real-world problems. Let's work together to bring your ideas to life with creativity and expertise." />
      </Head>
